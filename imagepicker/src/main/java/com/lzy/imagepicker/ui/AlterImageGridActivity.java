 ...
 * ================================================
 */
public class AlterImageGridActivity extends ImageBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alter_image_grid);
        ...
        if (mIsSkip) {
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
                if (!checkPermission(Manifest.permission.CAMERA)) {
                    ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA}, AlterImageGridActivity.REQUEST_PERMISSION_CAMERA);
                } else {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_ok) {
            Intent intent = new Intent(AlterImageGridActivity.this, PicViewerActivity.class);
            ...
            if (mFolderPopupWindow.isShowing()) {
                ...
                mFolderPopupWindow.showAtLocation(mTopBar, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            ...
            Intent intent = new Intent(AlterImageGridActivity.this, ImagePreviewActivity.class);
    ...
    private void createPopupFolderList() {
        ...
        mFolderPopupWindow.setMargin(mTopBar.getHeight());
    }
    ...
    public void onImageItemClick(View view, ImageItem imageItem, int position) {
        ...
        if (imagePicker.isMultiMode()) {
            ...
            if (imagePicker.isCrop()) {
                Intent intent = new Intent(AlterImageGridActivity.this, ImageCropActivity.class);
